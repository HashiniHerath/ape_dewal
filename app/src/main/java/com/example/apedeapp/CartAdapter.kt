...
class CartAdapter(
    ...
    override fun onBindViewHolder(holder: CartViewHolder, position: Int) {
        ...
        holder.cartItemTitle.text = cartItemList[position].cartItemName
        ...
        holder.updateCartItemBtn.setOnClickListener(){
            val intent = Intent(context, EditCartItem::class.java)
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
            intent.putExtra("cartItemID", cartItemList[position].cartItemID)
            intent.putExtra("cartItemTitle", cartItemList[position].cartItemName)
